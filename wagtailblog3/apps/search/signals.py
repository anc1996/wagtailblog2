...
def record_blog_page_published(sender, instance, **kwargs):
...
def record_blog_page_unpublished(sender, instance, **kwargs):
...
def request_scope_recalculation_on_restriction_change(sender, instance, **kwargs):
