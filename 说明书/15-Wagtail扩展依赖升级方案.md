...
- 数据、配置与回滚：未修改 `.env.production`、systemd unit、Nginx、Filebeat 配置、数据库、MongoDB、Redis、MinIO、页面、revision 或媒体，`systemctl.md` 无需更新。回滚点仍为生产前 commit `97a661b1e2f579ff549366b62234680d7688dfaf` 与 Wagtail 7.4.2；实施记录已随文档收尾 commit 同步到生产，不需要再次重启服务。
